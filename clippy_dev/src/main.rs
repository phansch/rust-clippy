...
fn update_lints() {
    ...
    replace_region_in_file(
        ...
        false,
        || {
            let mut lint_list_sorted = lint_list.clone();
            lint_list_sorted.sort_by_key(|l| l.name.clone());
            lint_list_sorted
                .iter()
                // TODO: It would be good to exclude internal lints in the lib because users of
                // the changelog and readme don't care about them anyway.
